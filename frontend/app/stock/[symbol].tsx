...
import { QualityTab, ValuationTab, GrowthTab, HealthTab, OwnershipTab, RiskTab, AINoteTab } from '@/src/components/FundamentalsTerminal';
  ...
  return (
    <SafeAreaView style={styles.safe} edges={['top']} testID="stock-detail-screen">
      ...
      <ScrollView contentContainerStyle={{ paddingBottom: 120 }}>
        ...
        {tab === 'risk' && <View style={styles.section}><RiskTab symbol={stock.symbol} /></View>}
