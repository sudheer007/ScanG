...
## Data Source
**Yahoo Finance public API** (v8 chart + v10 quoteSummary), accessed directly via curl_cffi browser impersonation. Caches: overview ~90s, quote batch 5 min, history/charts 5–10 min, full universe 8 min, fundamentals 60 min. Pre-warm + keep-warm on backend while the process is awake. Concurrent universe builds are single-flighted.
